...
* @route '/livewire-24bf663c/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-24bf663c/livewire.js',
...
* @route '/livewire-24bf663c/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-24bf663c/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-24bf663c/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-24bf663c/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>

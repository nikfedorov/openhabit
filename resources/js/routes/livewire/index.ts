...
* @route '/livewire-24bf663c/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-24bf663c/upload-file',
...
* @route '/livewire-24bf663c/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-24bf663c/preview-file/{filename}',

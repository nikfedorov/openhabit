...
return [
    ...
    'each_square_year' => 'Каждый квадрат — один год. Нажмите, чтобы увидеть недели.',
    'each_square_week' => 'Каждый квадрат — одна неделя. Нажмите чтобы увидеть подробности.',
    'seneca_quote' => '«Дело не в том, что нам отпущено мало времени, а в том, что мы много его тратим впустую.»',

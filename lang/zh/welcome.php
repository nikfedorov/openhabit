    ...
    'digest_examples' => [
        ...
        'items' => [
            [
                ...
                'paragraph_2' => '晨间日记在睡眠较晚时总是被遗漏——这是需要弥补的差距。今晚睡前写一句关于今天美好之事的话，这个小锚点能将今天与明天的晨间仪式连接起来。',
                'habits' => [
            ...
            [
                ...
                'date' => '2026年5月19日',
                'paragraph_1' => '早起和锻炼已完成，饮食保持清淡——在身体方面执行扎实。但午间的社交媒体滑落导致深度工作丢失，下午的结构也随之崩塌。',
                'paragraph_2' => '饮食纪律即使在失误后也能坚持，这是真正的优势。对于数字边界，增加摩擦：当感到想刷手机的冲动时，先做五个深蹲。小暂停，大重置。',
                'habits' => [
                    ['name' => '8点前起床', 'done' => true],
                    ['name' => '锻炼60分钟', 'done' => true],
                    ['name' => '冥想10-20分钟', 'done' => true],
